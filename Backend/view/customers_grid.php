...
<html lang="en">
    <head>
        ...
        <script src="JS/customer_grid.js"></script>
        ...
        <div id="wrapper">
         ...
         <div class="content">
                    ...
                    <div class="col-sm  mt-3">
                        <a href="customer_insert.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i> Add Customer</a>
                        <a href="#" id ="delete_all" class="btn btn-danger mb-2">Delete All</a>
                    </div>
                        <!-- start page title -->
                        <div class="row">
                            <div class="col-12">
