...
<html lang="en">
    <head>
        ...
        <script src="JS/admin_grid.js"></script>
                ...
                <div class="container-fluid">
                    ...
                    <div class="logo-box">
                        ...
                        <a href="index.html" class="logo logo-light text-center">
                            ...
                            <span class="logo-lg">
                                <img src="../assets/images/logo_1-removebg.png" alt="" height="20">
                            </span>
                        </a>
                    </div>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="col-sm  mt-3">
                        <a href="product_insert.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i> Add Products</a>
                        <a href="product_insert.php" id ="delete_all" class="btn btn-danger mb-2">Delete All</a>
                    </div>
                        <!-- start page title -->
                        <div class="row">
                            <div class="col-12">
